...
Download [[here](https://doi.org/10.5281/zenodo.7079304)](https://zenodo.org/badge/DOI/10.5281/zenodo.7079420.svg) (Zenodo) the data.zip (required), put it in the cloned GitHub folder and unzip it:
```bash
